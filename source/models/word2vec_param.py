...
class Param(object):
    ...
    def __init__(self, text_var, fake_subset=None):
        ...
        self.max_vocabulary_size = 10000 # Total number of different words in the vocabulary
        ...
        self.print_loss_every = 500
        self.print_valid_every = 10000
        self.save_embeddings_every = 10000
        self.nb_eval_words = 100
